...
/obj/effect/spawner/random/epic_loot/random_provisions
	...
	loot = list(
		...
		/obj/item/food/breadslice/corn = 1,
		...
		/obj/effect/spawner/random/food_or_drink/colonial_main = 1,
		/obj/effect/spawner/random/food_or_drink/colonial_side = 2,
		/obj/effect/spawner/random/food_or_drink/colonial_dessert = 1,
		/obj/effect/spawner/random/food_or_drink/ration_ticket_food = 1,
		/obj/effect/spawner/random/food_or_drink/ration_ticket_drink = 2,
