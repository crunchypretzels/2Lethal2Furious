...
/obj/item/reagent_containers/cup/borscht_bowl
	...
	fill_icon = 'modular_doppler/food_replicator/icons/rationpack.dmi'
...
/obj/item/food/colonial_course/nachos
	...
	desc = "A vacuum-sealed package with what seems to be a generous serving of triangular corn chips, with three sections reserved for a salsa, cheese and guacamole sauces.\
		<br> Probably the worst-looking food you can find in these rations; most systems discontinued these years ago."
	food_reagents = list(
