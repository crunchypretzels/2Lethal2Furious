/datum/component/shielded/shield_belt //ALL OF THIS IS FROM PAXIL'S SHIELD GLOVE PR
...
/datum/component/shielded/shield_belt/default_run_hit_callback(mob/living/wearer, attack_text, new_current_charges)
	...
	if(new_current_charges <= 0)
		...
		playsound(wearer, 'sound/items/weapons/parry.ogg', BLOCK_SOUND_VOLUME, TRUE)
